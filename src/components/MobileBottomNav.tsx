...
import { Home, FolderOpen, CheckCheck, ClipboardList } from "lucide-react";
...
const rightItems = [
  ...
  { to: "/my-work?tab=notes", icon: ClipboardList, label: "Notes" },
];
...
export function MobileBottomNav() {
  ...
  const isActive = (path: string) => {
    ...
    if (path === "/my-work?tab=notes")
      return location.pathname === "/my-work" && new URLSearchParams(location.search).get("tab") === "notes";
